...
import { LayoutDashboard, BookOpen, Radio, Flame, Users, Wallet, Menu, X } from 'lucide-react';

const NAV_ITEMS = [
  { href: '/admin', label: 'Dashboard', icon: LayoutDashboard, exact: true },
  { href: '/admin/courses', label: 'Courses', icon: BookOpen },
  { href: '/admin/free-classes', label: 'Free Classes', icon: Radio },
  { href: '/admin/specific-puja', label: 'Specific Puja', icon: Flame },
  { href: '/admin/users', label: 'Users', icon: Users },
  { href: '/admin/payments', label: 'Payments & Donations', icon: Wallet },
];
    ...
    <>
      ...
      >
        ...
        <div className="px-5 py-5 border-t border-white/10 text-xs text-[var(--sidebar-ink-soft)]">
          Signed in as <span className="text-[var(--sidebar-ink)] font-medium">Admin</span>
        </div>
      </aside>
    </>
  );
